...
//
// Solidity: event HoldCreated(uint256 holdId, uint256 holdAmount, address holder, address operator)
func (_Main *MainFilterer) FilterHoldCreated(opts *bind.FilterOpts) (*MainHoldCreatedIterator, error) {

	logs, sub, err := _Main.contract.FilterLogs(opts, "HoldCreated")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event HoldCreated(uint256 holdId, uint256 holdAmount, address holder, address operator)
func (_Main *MainFilterer) WatchHoldCreated(opts *bind.WatchOpts, sink chan<- *MainHoldCreated) (event.Subscription, error) {

	logs, sub, err := _Main.contract.WatchLogs(opts, "HoldCreated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
